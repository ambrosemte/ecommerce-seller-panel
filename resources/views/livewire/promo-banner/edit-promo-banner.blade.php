<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h3 class="fw-bold mb-0">Edit Promo Banner</h3>
    </div>

    <form wire:submit.prevent="editPromoBanner">
        <div class="mb-3 row">
            <div class="col">
        ...
        <div class="mb-3 row">
            <div class="col">
                ...
                <select class="form-control" id="storeId" wire:model.live="storeId" disabled>
            ...
            <div class="col">
                ...
                <input type="text" class="form-control" placeholder="Search product..."
                    wire:model.live.debounce.300ms="search" disabled>
        ...
        <button type="submit" class="btn btn-primary" wire:loading.attr="disabled" wire:target="editPromoBanner">
            <span wire:loading.remove wire:target="editPromoBanner">Submit</span>
            <span wire:loading wire:target="editPromoBanner">
