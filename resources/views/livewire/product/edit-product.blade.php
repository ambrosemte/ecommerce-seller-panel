<div class="container">
    ...
    <form wire:submit.prevent="updateProduct">
        ...
        <div class="mb-3">
                ...
                <div class="card p-3 mb-2">
                    ...
                    <div class="mt-2">
                        ...
                        <button type="button" class="btn btn-sm btn-outline-secondary mt-2"
                            ...
                            <span wire:loading.remove wire:target="addSpecification({{ $index }})">+ Add
                                Specification</span>
                            <span wire:loading wire:target="addSpecification({{ $index }})">
            ...
            @endforeach
            <small class="form-text text-muted">Max of 10 variations.</small><br>

            <button type="button" class="btn btn-outline-primary mt-3" wire:click="addVariation">
                <span wire:loading.remove wire:target="addVariation">
                    + Add Variation
                </span>
                <span wire:loading wire:target="addVariation">
                    <span class="spinner-border spinner-border-sm me-1"></span> Processing...
                </span>
            </button>
        </div>
